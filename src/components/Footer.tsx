      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-sans text-[10px] sm:text-xs text-slate-500 text-center sm:text-left">
            © {new Date().getFullYear()} Pandey Medical Hall. All rights reserved. Sourced from authentic pharma distributors in Bihar. Developed by <a href="https://main.webmakerit.com" target="_blank" rel="noopener noreferrer" className="text-brand-blue-500 hover:underline">WMIT</a>.
          </p>
